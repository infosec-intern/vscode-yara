...
suite("Snippet Provider", function () {
    ...
    test("it provides a meta section when the user types in the correct prefix", async function () {
    ...
    test("it provides support for snippet variables", async function () {
    ...
    test("it does not provide a meta section without the user typing the correct prefix", async function () {
